 ...
 */
function calculateTip(tipPercent, totBill) {
    totBill = parseFloat(totBill)
    tipPercent = Number(tipPercent/100).toLocaleString(undefined)
    return tipPercent * totBill

}
console.log(calculateTip(16,11.00).toFixed(2))
...
alert(`According to your bill and tip percentage, you must tip ${(finalTipTotal).toFixed(2)}`)
